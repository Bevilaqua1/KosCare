...
const calculateEANCheckDigit = (ean) => {
...
export const ean8P2Schema = z.string().regex(/^\d{8}\d{2}$/, {
    message: "EAN-8 P2 must be 8 digits followed by 2 extra digits",
});
export const ean8P5Schema = z.string().regex(/^\d{8}\d{5}$/, {
    message: "EAN-8 P5 must be 8 digits followed by 5 extra digits",
});
export const ean13P2Schema = z.string().regex(/^\d{13}\d{2}$/, {
    message: "EAN-13 P2 must be 13 digits followed by 2 extra digits",
});
export const ean13P5Schema = z.string().regex(/^\d{13}\d{5}$/, {
