...
export const TextValidationOptionsSchema = z.object({
    ...
    mimeType: BooleanSchema.or(z.object({
        exclude: z.string().array().optional(),
        include: z.string().array().optional(),
        type: z
            .enum([
    ...
    creditCardNumber: BooleanSchema.or(z.object({
        exclude: z.string().array().optional(),
        include: z.string().array().optional(),
        type: z.enum(["visa", "mastercard", "amex", "discover"]).optional(),
    })).optional(),
    phoneNumber: BooleanSchema.or(z.object({
        country: CountryCodeSchema.optional(),
        exclude: z.string().array().optional(),
        include: z.string().array().optional(),
    })).optional(),
    iban: BooleanSchema.or(z.object({
        exclude: z.string().array().optional(),
        include: z.string().array().optional(),
    })).optional(),
    ssn: BooleanSchema.or(z.object({
        exclude: z.string().array().optional(),
        include: z.string().array().optional(),
    })).optional(),
    currency: BooleanSchema.or(z.object({
        country: CountryCodeSchema.optional(),
    ...
    country: BooleanSchema.or(z.object({
...
export const TextOptionsSchema = TextValidationOptionsSchema.merge(TextTranformationOptionsSchema);
