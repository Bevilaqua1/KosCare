...
import { parseTypeAttributeName, parseTypeAttributes, } from "./parse-type.attribute";
import { parseArrayTypeAttribute } from "./parse-type.attribute.array";
import { visibilities } from "./visibility";
export function parseTypeWithContext(ctx) {
    ...
    if (ctx.tastesLike("[")) {
        ...
        while (ctx.moreFood() && ctx.taste() === "@") {
            ...
            if (visibilities.includes(attributeName)) {
...
export function parseFieldType(fieldName, source) {
