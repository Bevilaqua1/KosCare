 ...
 */
export function isHexDigit(_char) {
 ...
 */
export function isControl(_char) {
    return _char.split("").every((char) => {
        const code = char.charCodeAt(0);
