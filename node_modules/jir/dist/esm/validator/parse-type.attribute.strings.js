...
export function parseStringTypeAttribute(attributeName, ctx) {
    ...
    switch (attributeName) {
        ...
        case "hash": {
            ...
            const { data: algorithm, success } = HashingAlgorithmSchema.safeParse(val);
            if (!success) {
        ...
        case "encrypt": {
            ...
            const { data: algorithm, success } = EncryptionAlgorithmSchema.safeParse(val);
            if (!success) {
