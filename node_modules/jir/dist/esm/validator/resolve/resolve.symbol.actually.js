...
import { SymbolKind, SymbolSchema } from "../symbols";
import { resolveEntitySymbol } from "./resolve.symbol.entity";
export function actuallyResolveSymbol(_symbol, context) {
    const { data: symbol, success, error: symbolError, } = SymbolSchema.safeParse(_symbol);
    if (!success) {
