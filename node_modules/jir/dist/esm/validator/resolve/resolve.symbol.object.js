...
import { RawObjectSymbolSchema } from "../symbols/object";
...
export function resolveObjectSymbol(_symbol, context) {
    const symbol = resolveSymbolFromSchema(_symbol, RawObjectSymbolSchema.omit({
        properties: true,
    }));
