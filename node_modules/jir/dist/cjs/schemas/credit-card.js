...
exports.mastercardPrefixSchema = exports.visaPrefixSchema = void 0;
...
const creditCardSchema = zod_1.z
    .string()
    .regex(/^\d{13,19}$/, {
...
exports.visaPrefixSchema = zod_1.z
    .string()
    .regex(/^4/, { message: "Visa cards must start with a '4'" });
exports.mastercardPrefixSchema = zod_1.z
    .string()
