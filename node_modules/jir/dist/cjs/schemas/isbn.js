...
exports.isbnSchema = void 0;
const zod_1 = require("zod");
// Function to calculate ISBN-10 check digit
const calculateISBN10CheckDigit = (isbn) => {
    const digits = isbn
        .split("")
...
const calculateISBN13CheckDigit = (isbn) => {
    const digits = isbn.split("").map(Number);
    const sum = digits.reduce((acc, curr, index) => acc + curr * (index % 2 === 0 ? 1 : 3), 0);
    const mod = sum % 10;
    return mod === 0 ? "0" : String(10 - mod);
};
// Zod schema for validating ISBN-10 and ISBN-13
exports.isbnSchema = zod_1.z.string().refine((isbn) => {
